...
\begin{document}
    ...
    \transclude{the_sun}
	\transclude{sunspots}
	\transclude{suns_magnetic_field}
	\transclude{suns_structure}
	\section{Explaining the Sun's Spectrum}
	\transclude{suns_spectrum}
	\section{How Far Away is the Sun?}
	\transclude{how_far_away_is_the_sun}
